...
>
> ## ⚠️ HISTÓRICO — este manual ya no aplica
>
> Describe el **motor de cotización**, retirado el 2026-08-17
> ([ADR 007](../decisions/007-retiro-motor-cotizacion-costo-codigo.md)). El botón «Agregar
> personalización», el wizard y las solicitudes de aprobación **ya no existen**.
>
> **Los manuales vigentes son otros**, y están publicados en Información de Odoo:
>
> | Para | Archivo | Artículo |
> |---|---|---|
> | Cotizar | [`manual-vendedor-personalizacion.md`](manual-vendedor-personalizacion.md) | 75 |
> | Mantener precios | [`manual-admin-precios-personalizacion.md`](manual-admin-precios-personalizacion.md) | 74 |
>
> Se conserva este archivo porque documenta cómo funcionaba el motor, que es útil si
> alguna vez se revisa esa decisión. Lo de abajo describe un sistema que ya no existe.
