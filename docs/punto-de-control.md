...
- **19.3 trae imagen de producto nativa en el PDF** (`display_product_images_on_so`, hoy apagado). Si se activa, la imagen sale dos veces junto con nuestra columna. Decisión pendiente.
